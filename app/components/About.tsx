    ...
    <section id="about" className="py-24 bg-gradient-to-b from-mint via-white to-white dark:from-mint dark:via-black dark:to-black">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto mb-16 animate-fade-in">
          <div className="bg-white dark:bg-black shadow-lg p-8 rounded-lg transition-transform duration-300">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-black border border-mint/20 p-6 rounded-lg">
